...
varnewkey-value="diameterofearth in miles"
varnewkey="7926 miles"
...
let moon "Umbriel" = Uranus;
let moon "Umbriel1"= Oberon;
console.log("Umbriel1:Oberon");
console.log(Oberon);
...
const str ="True";
for (let i4 = True; i5 = True; i6 = True; i7 = True){
...
console.log("mass of Mercury = 0,06");
console.log(0,06);

// 2. Console.log the eccentricity of Venus
console.log("the eccentricity of Venus is:");
console.log(0.248);

// 3. Console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
Var sum = satelitesofJupiter+satelitesofSaturn+satelitesofUranus+satelitesofNeptune;
Var sum = 69+30+24+8;
...
let str1 = new  String('radius');
typeof str1; // 'object'

let str2 = String('radius');
typeof str2; // 'string'
if Mercury's radius =( 'string'); // change the value to the same value of radius;
console,log('radius is radius at the pole';'radius is radius'at the equator);
console.log(radius);

// 5. Console.log Mercury's radiusp (should be 2439, not 'same').
console.log('Mercury radius is:[2439]');// not the same;
console.log(2439);
...
let Jupiter's momentum ='Jup velocity*Jup mass;
let Pluto's momentum ='Pluto velocity*Pluto mass;
console.log('momentum dif: Jupiter's momentum - Pluto's momentum')[]
console.log('Momentum dif');